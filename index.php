...
<body>
 <div class="arkaplan">
 <form action="basvuru.php" name="basvuru" method="POST" >
 <h2>Yazılım Uzmanı Bilgi Formu</h2>
 <h3>Kişisel Bilgiler</h3>
 <table cellpadding="5px">
 <tr>
 <td>T.C. Kimlik</td>
 <td><input type="text" name="tc" class="form-control"></td>
 </tr>
 <tr>
 <td>Ad Soyad</td>
 ...
 <tr>
 <td>Fotoğraf Ekle</td>
 <td><input type="file" name="profil" id="fileToUpload" accept="image/*">
 ...
 <td>
 <input type="date" name="tarih" value="2015-01-01" class="form-control"></td>
 </tr>
 <tr>
 <td>Yazılım Deyimi</td>
 <td>
 <label><input type="radio" name="deneyim"> 1 - 5 yıl</label><br>
 <label><input type="radio" name="deneyim"> 6 - 10 yıl</label><br>
 </td>
 </tr>
 <tr>
...
<option>Pascal</option>
 ...
 <h3>Form Onay</h3>
 <label><input type="checkbox" name="onay"> Yukarıdaki bilgilerin doğruluğunu kabul ediyorum ve sözleşmeyi onaylıyorum.</label><br>
